    ...
    const columns = [
        ...
        { field: "TASK_PROJECT_LEAD", headerName: "Task Lead", width: 120 },
        {
            ...
            renderCell: (cellValues) => {
                console.log(cellValues.row.TASK_ID, "inlyonetaskid")
                setTaskid(cellValues.row.TASK_ID)
                return (
                    <button
                        variant="contained"
                        className="view-btn btn btn-primary"
                        style={{ padding: "2px 8px" }}
                        onClick={() => handleDetailButtonClick(cellValues.row.TASK_ID)}
                    >
                        Detail {console.log(cellValues.row.TASK_ID, "newone")}
                    </button>
                );
            },
        },
